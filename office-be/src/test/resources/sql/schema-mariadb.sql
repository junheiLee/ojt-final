...
CREATE TABLE tStandardProduct (
                                  ...
                                  nMinPcPrice INTEGER NULL DEFAULT 0,
                                  nMinMobilePrice INTEGER NULL DEFAULT 0,
                                  nMinPrice INTEGER NULL DEFAULT 0,
                                  nAvgPrice INTEGER NULL DEFAULT 0,
...
-- 링크 pk
ALTER TABLE tLink
    ADD CONSTRAINT PK_tLink -- 링크 기본키
        PRIMARY KEY (
                     sPartnerProductCode -- 상품코드
            );
